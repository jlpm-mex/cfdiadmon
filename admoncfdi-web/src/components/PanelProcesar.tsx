  ...
  return (
    <table className="w-full text-left text-slate-300 border-collapse">
      ...
      <tbody>
        {pendingDocs.map((v, k) => {
          return (
            <tr key={k} className="border-b border-white/5 hover:bg-white/2 transition-colors">
...
const PanelProcesar = () => {
  ...
  return (
    <section className="space-y-6">
            ...
            <table className="w-full text-left text-slate-300 border-collapse">
              ...
              <tbody>
                ...
                {processResult.processedList.map((doc, idx) => (
                  <tr key={`success-${idx}`} className="border-b border-white/5 hover:bg-emerald-500/3">
                ...
                {processResult.unprocessedList.map((doc, idx) => (
                  <tr key={`fail-${idx}`} className="border-b border-white/5 hover:bg-rose-500/3">
                    <td className="py-3 px-4 font-mono text-sm">{doc.xmlName}</td>
                    <td className="py-3 px-4">
      ...
      {!processDocsSuccess && (
        <>
          <div className="rounded-[18px] border border-white/10 bg-linear-to-b from-[#16263D] to-[#16263D]/60 p-7 min-h-64 overflow-x-auto">
            {pendingDocsSuccess && (
